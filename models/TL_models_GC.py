...
def MNetV2(num_classes, train_layers, class_weights, save_model_path, save_ckp_path, image_height, image_width, ds_train, ds_val, lr_rate, num_epochs):

    num_classes = num_classes
    print("the num_classes is:  ", num_classes)
    ...
    # add the specific classifier to the pre-trained model (downloaded from Keras)  
    x = mobile_model.output
    x = tf.keras.layers.GlobalAveragePooling2D(name="global_average_pooling2d")(x)
    model_out = tf.keras.layers.Dense(num_classes, activation='softmax', name="dense")(x)
    model_MobileV2 = Model(inputs=mobile_model.input, outputs=model_out)
    ...
    if save_ckp_path is None:
      print("No checkpoint file will be saved")
    else:
...
def IncV3(num_classes, train_layers, class_weights, save_model_path, save_ckp_path, image_height, image_width, ds_train, ds_val, lr_rate, num_epochs):
    num_classes = num_classes
    print("the num_classes is:  ", num_classes)
    epochs = num_epochs
    ...
    x = tf.keras.layers.GlobalAveragePooling2D(name="global_average_pooling2d")(x)
    model_out = tf.keras.layers.Dense(num_classes, activation='softmax', name="dense")(x)
    model_InceptionV3 = Model(inputs=InceptionV3_model.input, outputs=model_out)
...
def ResN50(num_classes, train_layers, class_weights, save_model_path, save_ckp_path, image_height, image_width, ds_train, ds_val, lr_rate, num_epochs):
    num_classes = num_classes
    print("the num_classes is:  ", num_classes)
    epochs = num_epochs
    ...
    x = tf.keras.layers.GlobalAveragePooling2D(name="global_average_pooling2d")(x)
    model_out = tf.keras.layers.Dense(num_classes, activation='softmax', name="dense")(x)
    model_ResNet50 = Model(inputs=ResNet50_model.input, outputs=model_out)
...
def DenseN121(num_classes, train_layers, class_weights, save_model_path, save_ckp_path, image_height, image_width, ds_train, ds_val, lr_rate, num_epochs):
    num_classes = num_classes
    print("the num_classes is:  ", num_classes)
    epochs = num_epochs
    ...
    x = tf.keras.layers.GlobalAveragePooling2D(name="global_average_pooling2d")(x)
    model_out = tf.keras.layers.Dense(num_classes, activation='softmax', name="dense")(x)
    model_DenseNet121 = Model(inputs=DenseNet121_model.input, outputs=model_out)
...
def SqueezeN(num_classes, train_layers, class_weights, save_model_path, save_ckp_path, image_height, image_width, ds_train, ds_val, lr_rate, num_epochs):
    sq1x1 = "squeeze1x1"
    exp1x1 = "expand1x1"
    exp3x3 = "expand3x3"
    relu = "relu_"
    ...
    x = tf.keras.layers.Conv2D(1000, (1, 1), strides=1, padding='valid', name='conv10')(x)
    x = tf.keras.layers.GlobalAveragePooling2D(name="global_average_pooling2d")(x)
    model_out = tf.keras.layers.Dense(num_classes, activation='softmax', name="dense")(x)
    model_SqueezeNet = Model(inputs=SqueezeNet_model.input, outputs=model_out)
